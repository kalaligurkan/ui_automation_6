...
Practice your automation skills
    ...
    public void validateDynamicElementBox1(){
        ...
        WebElement box1 = driver.findElement(By.xpath("//p[starts-with(@id, 'box_1_')]")); //By.cssSelector("p[id^='box_1_'")
    ...
    public void validateDynamicElementBox2(){
        ...
        WebElement box2 = driver.findElement(By.xpath("//p[starts-with(@id, 'box_2_')]"));
